...
export const metadata: Metadata = {
  ...
  description: "Experience world-class luxury at Grand Vista Hotel. Premium rooms, fine dining, spa services, and exceptional hospitality in an elegant setting.",
  keywords: "luxury hotel, 5-star accommodation, premium rooms, fine dining, spa services, business travel, vacation resort",
  openGraph: {
    title: "Grand Vista Hotel - Luxury 5-Star Accommodation",
    description: "Experience world-class luxury at Grand Vista Hotel with premium rooms, fine dining, and exceptional service.",
    ...
    images: [
      {
        ...
        alt: "Grand Vista Hotel exterior at golden hour"
      }
    ],
    type: "website"
  },
